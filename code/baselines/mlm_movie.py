...
for index in range(num_runs):
    ...
    if model == 'en':
        accuracy_scores, f1_scores = final_model('data/imdb_pos_5000', 'data/imdb_neg_5000', 'data/imdb_sent_pos', 'data/imdb_sent_neg', mode=target)
    if model == 'trt':
        accuracy_scores, f1_scores = final_model('data/imdb_pos_5000_'+target, 'data/imdb_neg_5000_'+target, 'data/imdb_sent_pos_'+target, 'data/imdb_sent_neg_'+target, mode=target)
    if model == 'tlt':
        accuracy_scores, f1_scores = final_model('data/imdb_pos_5000_'+target+'_'+mode, 'data/imdb_neg_5000_'+target+'_'+mode, 'data/imdb_sent_pos_'+target+'_'+mode, 'data/imdb_sent_neg_'+target+'_'+mode, mode=target)
    if model == 'combo':
        accuracy_scores, f1_scores = final_model('data/combo_pos_'+target, 'data/combo_neg_'+target, 'data/combo_sent_pos_'+target, 'data/combo_sent_neg_'+target, mode=target)
    translated_acc.append(accuracy_scores[0])
    translated_f1.append(f1_scores[0])
    transliterated_acc.append(accuracy_scores[1])
    transliterated_f1.append(f1_scores[1])
    english_acc.append(accuracy_scores[2])
    english_f1.append(f1_scores[2])

print("-----average-----")
print("TR_acc= ", np.mean(translated_acc))
print("TR_f1= ", np.mean(translated_f1))
print("TL_acc= ", np.mean(transliterated_acc))
print("TL_f1= ", np.mean(transliterated_f1))
print("EN_acc= ", np.mean(english_acc))
print("EN_f1= ", np.mean(english_f1))
